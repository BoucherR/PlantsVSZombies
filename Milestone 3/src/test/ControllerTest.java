...
public class ControllerTest {
    ...
    public void testController(){
        ...
        assertEquals("The Piece placed is Sunflower","/Images/sunflower.png",guiView.getGameButtons()[1][1].getIcon().toString());
        assertEquals("The Piece placed is Peashooter","/Images/peashooter.png",guiView.getGameButtons()[2][1].getIcon().toString());
        ...
        assertEquals("The Piece placed is TwinSunflower","/Images/twinsunflower.png",guiView.getGameButtons()[1][2].getIcon().toString());
        ...
        assertEquals("The Piece placed is Wallnut","/Images/wallnut.png",guiView.getGameButtons()[1][3].getIcon().toString());
        assertEquals("The Piece placed is Repeater","/Images/repeater.png",guiView.getGameButtons()[2][3].getIcon().toString());
